            ...
            try
            {
                ...
                switch (requestLogin.aplicacion)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        response.Object = repositoryMicroventas.GetDataByProcedure<LoginDTO>("shParqueos.spLogin", requestLogin.usuario, requestLogin.password, poRespuesta, poLogRespuesta).FirstOrDefault();
                        break;
                    default:
                        break;
                }
